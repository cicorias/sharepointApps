...
public partial class TokenHelper2
{
        ...
        ClaimProviderType IdentityClaimProviderType)
    {
        ...
        string realm = string.IsNullOrEmpty(Realm) ? TokenHelper.GetRealmFromTargetUrl(targetApplicationUri) : Realm;
        ...
        ClaimProviderType IdentityClaimProviderType)
    {
        ...
        if (IdentityClaimProviderType == ClaimProviderType.SAML)
            claimSet["nii"] = "urn:office:idp:trusted:" + TrustedProviderName.ToLower();
        else
        ...
        IdentityClaimType SamlIdentityClaimType)
    {
        ...
        ClaimsUserIdClaim id = new ClaimsUserIdClaim();
